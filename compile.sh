...
if uname -s | grep -i -c "LINUX" > /dev/null; then 
    ...
    echo "compiling...";    
    # gcc $ARGS1 $ARGS2 -o tdfsb tdfsb.c -I/usr/local/include -I/usr/include/ -I/usr/X11R6/include -L/usr/lib/ -L/usr/local/lib/ -L/usr/X11R6/lib -lSDL_image -lGL -lGLU -lglut -lXmu -lXi -lXext -lX11 -lm -lsmpeg -D_THREAD_SAFE -O2 -x c -o tdfsb tdfsb.c;
    # hacked for Ubunut 18.04 
    gcc -o tdfsb tdfsb.c -I/usr/include/SDL -I/usr/include/SDL -D_REENTRANT -I/usr/include/ -L/usr/lib/x86_64-linux-gnu/ -L/lib/x86_64-linux-gnu/ -lm -lSDL -lSDL_image -lGL -lGLU -lglut -lXmu -lXi -lXext -lX11 -lsmpeg -D_THREAD_SAFE -O2 -x c -w;
